...
def real2titan(filePath, savePath="test.png"):
    ...
    async def on_ready():
        try:
            ...
            await channel.send(content=f"$R::B2A>{requestID}$2",file=discord.File(filePath))
...
if __name__ == "__main__":
    ...
    real2titan(args.path, savePath = args.savepath)