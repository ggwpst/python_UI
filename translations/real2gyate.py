...
def real2gyate(filePath, savePath="test.png"):
    ...
    async def on_ready():
        try:
            ...
            await channel.send(content=f"$R::B2A>{requestID}$3",file=discord.File(filePath))
...
if __name__ == "__main__":
    ...
    real2gyate(args.path, savePath = args.savepath)