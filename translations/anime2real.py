...
def anime2real(filePath, savePath="test.png"):
    ...
    async def on_ready():
        try:
            ...
            await channel.send(content=f"$R::B2A>{requestID}$0",file=discord.File(filePath))
...
if __name__ == "__main__":
    ...
    anime2real(args.path, savePath = args.savepath)